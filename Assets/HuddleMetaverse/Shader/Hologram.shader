Shader "Custom/EnhancedHologramShader"
{
    Properties
    {
        ...
        _RayWidth("Ray Width", Range(10.0, 500.0)) = 20.0
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    float3 hologram = col * hologramEffect * _RayIntensity;
                    hologram = lerp(col, hologram, _Intensity);

                    float3 rayEffect = _RayColor.rgb * hologramEffect * _RayIntensity;
                    rayEffect = lerp(rayEffect, col, 1.0 - _RayTransparency);
